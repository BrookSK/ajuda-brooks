...
<div style="max-width: 1100px; margin: 0 auto;">
    <div style="display:flex; justify-content:space-between; align-items:flex-end; gap:10px; flex-wrap:wrap; margin-bottom:12px;">
        ...
        <div style="display:flex; gap:8px; flex-wrap:wrap;">
            <a href="/comunidades" style="border-radius:999px; padding:9px 14px; background:<?= $_btnBg ?>; color:<?= htmlspecialchars($_brandBtnTextColor) ?>; font-weight:800; text-decoration:none; font-size:13px;">Abrir comunidades</a>
